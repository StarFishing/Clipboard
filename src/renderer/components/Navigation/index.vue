...
export default {
  ...
  methods: {
    ...
    changebackgroud () {
      ...
      const csstext = '#app{height:100%;background-image: url("https://img.pc841.com/2018/0730/20180730081702510.jpg");background-repeat: no-repeat;background-size: cover;}.homepage {background: none} .sidebarWrapper {background: none;}.navigationWrapper {background: none; }.shadow {background-color: rgba(255, 255, 255, 0.38);}'
      if (this.toggle) {
